...
export class UserResolverBase {
  ...
  @common.UseInterceptors(AclFilterResponseInterceptor)
  @graphql.ResolveField(() => [Employer], { name: "employers" })
  @nestAccessControl.UseRoles({
    resource: "Employer",
    action: "read",
    possession: "any",
  ...
  async findEmployers(
    ...
    const results = await this.service.findEmployers(parent.id, args);
  ...
  @common.UseInterceptors(AclFilterResponseInterceptor)
  @graphql.ResolveField(() => [JobSeeker], { name: "jobSeekers" })
  @nestAccessControl.UseRoles({
    resource: "JobSeeker",
    action: "read",
    possession: "any",
  ...
  async findJobSeekers(
    ...
    const results = await this.service.findJobSeekers(parent.id, args);
